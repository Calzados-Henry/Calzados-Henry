...
export default function ProductDetail() {
  ...
  const added = useAppSelector(state => (user ? state.apiCart : state.cart));

  const shoe: ProductPartial = products.find(
    (item: ProductPartial) =>
      params.id !== undefined && item.id !== undefined && item.id === parseInt(params.id),
  );
