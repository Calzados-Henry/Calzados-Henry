...
Category.get('/category', async (_req:Request , res:Response)=>{
    try {
...
Category.post('/category', async (req: Request, res: Response)=>{
    try {
...
Category.patch('/category', async (req: Request, res: Response)=>{
    try {
...
Category.delete('/category', async (req: Request, res: Response)=>{
    try {
